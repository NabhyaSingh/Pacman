var lives = 3 ;
var score = 0 ;
var wall1,wall2,wall3,wall4,wall5,wall6,wall7,wall8,wall9,wall10,wall11,wall12,wall13,wall14,wall15,wall16,wall17,wall18,wall19,wall20,wall21,wall22,wall23,
wall24,wall25,wall26;
var red,blue;
var coinImg;
function preload(){
  coinImg = loadImage("pacman coins.png");
  redImg = loadImage("red ghost.png");
  blueImg = loadImage("blue ghost.png");
  logoImg = loadImage("pacman logo.png");
  heartImg = loadImage("retro_red_heart_1.png");
...
function draw() {
  ...
  if(keyDown("left")){
    pacman.setAnimation(pacmanLeft);
    pacman.scale = 0.02;
    pacman.velocityX = -4 ;
    pacman.velocityY = 0 ;
  }
